...
readonly caSubject=${CA_SUBJECT:-/C=CN/ST=Shanghai/L=Shanghai/O=KubeEdge/CN=kubeedge.io}
readonly certPath=${CERT_PATH:-/etc/kubeedge/certs}
readonly subject=${SUBJECT:-/C=CN/ST=Shanghai/L=Shanghai/O=KubeEdge/CN=kubeedge.io}
...
stream() {
    ...
    index=1
    SUBJECTALTNAME="subjectAltName = IP.1:10.101.4.34"
